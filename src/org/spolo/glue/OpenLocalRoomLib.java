...
public class OpenLocalRoomLib extends GUtilCommand {
	
	public OpenLocalRoomLib(){
		super();
//		this.url = "http://www.xuanran001.com/s/gh/local/roomlib/index.html";
		this.url = MappingURL.getLocalRoomLib();
	}
