...
public class HomeFramePane extends JRootPane implements View {
   ...
   */
  public JFrame homeFrame = null;
  public static HomeFramePane instance;
  public static HomeFramePane getInstance(){
      return instance;
  }
  ...
  private void updateFrameTitle(JFrame frame, 
    ...
    if (OperatingSystem.isMacOSX()) {
      ...
      String companyName = GlueUtil.getUserProperty(GlueUtil.Company);
      title += " - " +(companyName==null?application.getName():companyName); 
