...
public class SwingViewFactory implements ViewFactory {
   ...
   */
  public View createImportedTextureWizardStepsView(String flag,
                      CatalogTexture texture, String textureName,
                      UserPreferences preferences,
                      ImportedTextureWizardController importedTextureWizardController) {
    return new ImportedTextureWizardStepsPanel(flag,texture, textureName, preferences,
   ...
   * Returns a new view that edits room values.
   */
  public DialogView createDeleteCatchView(UserPreferences preferences,
                                   DeleteCatchController roomController) {
    return new DeleteCatchPanel(preferences, roomController);
  }
