...
public class RoomPanel extends JPanel implements DialogView {
  ...
  private void createComponents(UserPreferences preferences, 
    ...
    if (controller.isPropertyEditable(RoomController.Property.NAME)) {
      ...
      this.smartLayout = new JButton(SwingTools.getLocalizedLabelText(preferences, 
              RoomPanel.class, "smartlayout"));
      smartLayout.addActionListener(controller.getSmartLayoutListener());
  ...
  private void layoutComponents(UserPreferences preferences) {
    ...
    if (this.nameLabel != null || this.areaVisibleCheckBox != null) {
      ...
      if(this.smartLayout!=null){
          nameAndAreaPanel.add(this.smartLayout, new GridBagConstraints(
  ...
  public void displayView(View parentView) {
    if (SwingTools.showConfirmDialog((JComponent)parentView, 
    	...
    	System.out.println(this.controller.isSmartLayout());
    	if (!this.controller.isSmartLayout()) {
