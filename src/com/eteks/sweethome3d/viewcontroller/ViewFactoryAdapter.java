...
public class ViewFactoryAdapter implements ViewFactory {
   ...
   * @throws UnsupportedOperationException
   */
  public View createImportedTextureWizardStepsView(String flag,CatalogTexture texture, String textureName,
  ...
  public DialogView createDeleteCatchView(UserPreferences preferences,DeleteCatchController deleteCatchController) {
	throw new UnsupportedOperationException();
  }
