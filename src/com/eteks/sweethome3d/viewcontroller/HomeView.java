...
public interface HomeView extends View {
  ...
  public enum ActionType {
      ...
      VIEW_FROM_TOP, VIEW_FROM_OBSERVER, SWITCH_VISIBLE, MODIFY_OBSERVER, STORE_POINT_OF_VIEW, DELETE_POINTS_OF_VIEW, CREATE_PHOTOS_AT_POINTS_OF_VIEW, DETACH_3D_VIEW, ATTACH_3D_VIEW,  
      DISPLAY_ALL_LEVELS, DISPLAY_SELECTED_LEVEL, MODIFY_3D_ATTRIBUTES, CREATE_PHOTO, CREATE_VIDEO, EXPORT_TO_OBJ, EXPORT_HOUSE_TO_OBJ,
      HELP, /*glue 按钮---start*/ABOUT,CLOUD_MODEL_DOWNLOAD,CLOUD_RENDER,CREATE_TENDER,CLOUD_HOME_MODEL,CLOUD_APARTMENT_MODEL,CLOUD_OUTDOOR_SCENE,MANAGRENDERJOB,MANAGE_TENDER,
      MYRESULTPIC,EXPORTHOME, USERCENTER, SINGLE_CLOUD_RENDER, DELETE_FURNITURE, LOCAL_HOME_MODEL, DELETECATCH,STORAGE_ROOM/*glue 按钮---end*/,
      DELETE_ALL_PROJECTS}
   ...
   * Shows a content chooser save dialog to export a 3D home in a OBJ file.
   */
  public abstract String showExportHouseToOBJDialog(String homeName);
  ...
  /**
   * Exports the 3D house objects to a given OBJ file.
   * Caution !!! This method may be called from a threaded task.  
   */
  public abstract void exportHouseToOBJ(String objFile) throws RecorderException;
  
  /**
   * Exports the 3D new added house objects to a given OBJ file.
   * Caution !!! This method may be called from a threaded task.  
   */
  public abstract void exportNewAddedHouseToOBJ(String objFile) throws RecorderException;
  ...
  public abstract void invokeLater(Runnable runnable);
	...
	public abstract void setHomeController(HomeController homeController);
}