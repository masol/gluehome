...
public class HomeController3D implements Controller {
  ...
  public void viewFromObserver() {
	 ...
	 */
	private void showconfirmDialog(Camera c) {
		JOptionPane.showMessageDialog(
						null,
						"\u5F53\u524D\u4FDD\u5B58\u7684\u89C6\u89D2\u4E0E\u60A8\u4FDD\u5B58\u7684\u89C6\u89D2 \u201C" + c.getName() + "\u201D \u76F8\u540C\uFF01","提示",JOptionPane.WARNING_MESSAGE);
	}
  ...
  public void storeCamera(String name) {
	  Camera camera = this.home.getCamera().clone();
    	...
    	for (Iterator<Camera> it = storedCameras.iterator(); it.hasNext(); ) {
	      ...
	      //判断摄像机视角是否相同
	     if (camera.getX() == storedCamera.getX()
	    	 ...
	    	 showconfirmDialog(storedCamera);
	    	 return;
	     }else if (name.equals(storedCamera.getName())) {
