...
public class Room implements Serializable, Selectable, Elevatable {
  ...
  private boolean addedRoom = true;
  
  private List<List<HomePieceOfFurniture>> smartLayoutElements;
  
  public void setAdded(boolean newAdded){
	  this.addedRoom = newAdded;
  }
  
  public boolean isNewAddedRoom(){
...
public List<List<HomePieceOfFurniture>> getSmartLayoutElements() {
	return smartLayoutElements;
}

public void setSmartLayoutElements(List<List<HomePieceOfFurniture>> smartLayoutElements) {
	this.smartLayoutElements = smartLayoutElements;
}
